  ...
  render() {
    return (
      <div className="App">
        ...
        <div class="scores p1">
          <p class="player1"><span class="p1">Jugador</span><span class="p2">Player 1</span> (<span class="x"></span>)<span class="score">{this.state.playerWin}</span></p>
          <p class="ties">Empate<span class="score">{this.state.tieGames}</span></p>
          <p class="player2"><span class="p1">Ordenador</span><span class="p2">Player 2</span> (<span class="o"></span>)<span class="score">{this.state.computerWin}</span></p>
        </div>
      </div>
    );
  }
